...
Using R as a calculator, after running our F-tests we find that copper content (%) has an effect on warping, though temperature does not.  There is no interaction between the two.
