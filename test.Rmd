...
```{r}
surface <- as.data.frame(x = matrix(data = c(rep(c(.2, .25, .3), each = 3, times = 4), rep(c(.15, .18, .2, .25), each = 9), c(74, 64, 60, 92, 86, 88, 99, 98, 102, 79, 68, 73, 98, 104, 88, 104, 99, 95, 82, 88, 92, 99, 108, 95, 108, 110, 99, 99, 104, 96, 104, 110, 99, 114, 111, 107)), nrow = 36, byrow = FALSE))
